<x-blog-layout :meta-title="$category->name" :meta-description="$category->description">
...
<div
    class="prose prose-slate mx-auto mt-6 dark:prose-invert lg:prose-xl text-white"
>
    <p>
