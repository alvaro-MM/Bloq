<header class="bg-gray-800 px-6 shadow dark:bg-slate-900">
    <div
    ...
    >
        ...
        <a
            href="{{route('about')}}"
            class="block rounded-md px-3 py-2 text-slate-700 transition-colors hover:bg-sky-500 hover:text-white dark:text-slate-400 dark:hover:text-white"
        >
            About
        </a>
        <a
